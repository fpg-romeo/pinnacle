<div class="br-mainpanel mg-0">
    <div class="br-pagebody pd-0 mg-0">
        <form id="form-import-lead" method="post" enctype="multipart/form-data">
            ...
            <hr>
            <div class="row mb-5">
                <label class="col-sm-3 form-control-label">Transaction Type <span class="tx-danger">*</span></label>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-lg-6">
                            <label class="rdiobox">
            ...
            <div class="row mb-5">
                <label class="col-sm-3">Upload File <span class="tx-danger">*</span></label>
                <div class="col-sm-9">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.upload', function(e) {
        ...
        $.ajax({
            url: '/underwriting/import-renewal-json/',
            type: 'POST',
            data: fd,
            processData: false,
            contentType: false,
