    <div class="br-mainpanel">
        <div class="br-pageheader">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <a class="breadcrumb-item" href="/">Account Company</a>
        ...
        <div class="br-pagetitle pos-relative">
            ...
            <div>
                <h4>Account Company <b class="tx-primary">[ Records ]</b></h4>
                    ...
                    <table class="table table-bordered display table_default">
                        <thead class="thead-colored thead-dark">
                            <tr>
                                ...
                                <th class="wd-5p"><center>ACTION</center></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                        ...
                                        echo '<tr id="'.$value['id'].'">
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu pd-5">
                                                        ...
                                                        <a id="'.htmlDecode($value['id']).'" class="nav-link edit" data-action="edit" title="Update Record" ><i class="fa fa-pencil-square-o"></i>Update Record</a>';
                                                    if(ACCOUNT_TYPE_ID == arrayKeyExist($data, 'account_type_administrator')) {
                                                        echo '<a id="'.htmlDecode($value['id']).'" class="nav-link delete" data-action="delete" data-title="'.htmlDecode($value['name']).'" title="Delete Record" ><i class="fa fa-trash"></i>Delete Record</a>';
                                                    }
                                                    echo ' 
                                                        </nav>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.submit', function(e){
            ...
            if($('#form .required').length <= 0) {
                $.ajax({
                    url: '/master/account-company-json/',
                    type: 'POST',
                    data: $('#form').serialize(),
                    beforeSend: function(){
