      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive text-nowrap">
              <table class="table table-bordered">
                ...
                <tbody class="table-border-bottom-0">
                  <?php if (!empty($data['team_leaders']) && is_array($data['team_leaders'])) { ?>
                    <?php
                  ...
                  <?php } else { ?>
                    <tr>
                      <td colspan="4" class="text-center">No Team Leaders found</td>
                    </tr>
                  <?php } ?>
                </tbody>
              </table>
            ...
            <?php if (is_array($data['team_leaders'])) { ?>
              <div class="row justify-content-between">
                ...
                <div class="col-md-auto ms-auto mt-5">
                  <ul class="pagination">
                    <?php echo tool_pagination(getVar('page'), $data['total_page'], '/master/team-leader/', 'page', true); ?>
                  </ul>
                </div>
