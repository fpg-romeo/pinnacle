    <div class="br-mainpanel">
        <div class="br-pageheader">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <a class="breadcrumb-item" href="/">Account Designation</a>
        ...
        <div class="br-pagetitle pos-relative">
            ...
            <div>
                <h4>Account Designation <b class="tx-primary">[ Records ]</b></h4>
                            ...
                            <?php
                                if(is_array($data['designation'])){
                                    foreach($data['designation'] as $key => $value){
                                        echo '<tr id="'.$value['id'].'">
                                                <td>'.htmlDecode($value['department_name']).'</td>
                        ...
                        <div class="row mg-b-15">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                <select name="department_id" class="form-control select" required>
                                    <?php echo tool_dropdown_option($data['department'], '', 'name'); ?>
                                </select>
                            </div>
                        </div>
                        <div class="row">
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.submit', function(e){
            ...
            if($('#form .required').length <= 0) {
                $.ajax({
                    url: '/master/account-designation-json/',
                    type: 'POST',
                    data: $('#form').serialize(),
                    beforeSend: function(){
            ...
            $(document).on('click', '.edit', function(e){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('select[name=department_id]').val(data.department_id).find("option[value=" + data.department_id +"]").attr('selected', true);
