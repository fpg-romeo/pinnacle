<div class="br-mainpanel">
        <div class="br-pageheader">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                <a class="breadcrumb-item" href="/">Encode Summary</a>
                ...
                <div class="card bd">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs tx-bold">
                            <li class="nav-item">
                                <a href="/company/encode-summary/1/" class="nav-link tab-link active">SUMMARY</a>
                            </li>
                            <li class="nav-item">
                                <a href="/company/encode/1/" class="nav-link tab-link">ALL RECORDS</a>
                            </li>
        ...
        $(document).ready(function(){
            $('.pagination').bind('blur change',function(e){
                ...
                if(account_type_id != account_type_encoder){
                    ...
                    var parameter        = '?page=1&limit='+limit;
                }
