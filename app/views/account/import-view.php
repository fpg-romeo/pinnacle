<div class="br-mainpanel mg-0">
    <div id="accordion" class="accordion accordion-head-colored accordion-info" role="tablist" aria-multiselectable="true">
        ...
        <div class="card">
            <div class="card-header" role="tab" id="headingFive">
                <h6 class="mg-b-0">
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-bank" aria-expanded="false" class="collapsed tx-gray-800 transition mg-b-0-force"><i class="fa fa-caret-right"></i> BANK INFORMATION</a>
                </h6>
            </div>
            <div id="tab-bank" class="collapse">
                <div class="card-block pd-10">
                    <div class="bd rounded">
                        <table class="table table-bordered mg-b-0 table-responsive d-md-table">
                            <tr>
                                <td class="wd-20p">Bank Name</td>
                                <td class="wd-80p tx-bold"><?php echo multiArrayKeyExist($data, 'account_bank', 'name') ?></td>
                            </tr>
                            <tr>
                                <td>Bank Account Number</td>
                                <td class="tx-bold"><?php echo multiArrayKeyExist($data, 'account_bank', 'account_no') ?></td>
                            </tr>
                            <tr>
                                <td>Payee Name (as of bank account)</td>
                                <td class="tx-bold"><?php echo multiArrayKeyExist($data, 'account_bank', 'payee_name') ?></td>
                            </tr>
                            <tr>
                                <td>Bank Code</td>
                                <td class="tx-bold"><?php echo multiArrayKeyExist($data, 'account_bank', 'code') ?></td>
                            </tr>
                            <tr>
                                <td>Branch Code</td>
                                <td class="tx-bold"><?php echo multiArrayKeyExist($data, 'account_bank', 'branch_code') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header" role="tab" id="headingFive">
                <h6 class="mg-b-0">
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-emergency" aria-expanded="false" class="collapsed tx-gray-800 transition mg-b-0-force"><i class="fa fa-caret-right"></i> EMERGENCY CONTACT PERSON</a>
                </h6>
            </div>
            <div id="tab-emergency" class="collapse">
                <div class="card-block pd-10">
                    <div class="bd rounded">
                        <table class="table table-bordered mg-b-0 table-responsive d-md-table">
                            <tr>
                                <td class="wd-20p">Name</td>
                                <td class="wd-80p tx-bold"><?php echo multiArrayKeyExist($data, 'account_emergency_contact', 'name') ?></td>
                            </tr>
                            <tr>
                                <td>Contact Number</td>
                                <td class="tx-bold"><?php echo multiArrayKeyExist($data, 'account_emergency_contact', 'contact_no') ?></td>
                            </tr>
                            <tr>
                                <td>Relationship</td>
                                <td class="tx-bold"><?php echo multiArrayKeyExist($data, 'account_emergency_contact', 'relationship') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header" role="tab" id="headingSix">
                <h6 class="mg-b-0">
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-equipment" aria-expanded="false" class="collapsed tx-gray-800 transition mg-b-0-force"><i class="fa fa-caret-right"></i> EQUIPMENT ASSIGNMENT</a>
                </h6>
            </div>
            <div id="tab-equipment" class="collapse">
                <div class="card-block pd-10">
                    <div class="bd rounded">
                        <table class="table table-bordered mg-b-0 table-responsive d-md-table">
                            <tr>
                                <td class="wd-20p">Computer Type</td>
                                <td class="wd-80p tx-bold"><?php echo multiArrayKeyExist($data, 'account_equipment', 'computer_type') ?></td>
                            </tr>
                            <tr>
                                <td>Computer Serial Number</td>
                                <td class="tx-bold"><?php echo multiArrayKeyExist($data, 'account_equipment', 'computer_serial_no') ?></td>
                            </tr>
                            <tr>
                                <td>Locker Number</td>
                                <td class="tx-bold"><?php echo multiArrayKeyExist($data, 'account_equipment', 'locker_no') ?></td>
                            </tr>
                            <tr>
                                <td>Accessories</td>
