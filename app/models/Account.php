    ...
    class Account{
        ...
        public static function login($username, $password){
            $result = mysql::select('account acc
                                    ...
                                    "aem.email = '{$username}' AND acc.password = '{$password}' AND aem.account_status_id = 1 "); //account_status_id = 1 : ACTIVE
            return $result;
        }
        ...
        public static function getRecordById($id){
            $result = mysql::select('account_employment aem USE INDEX(account_id)
                                     LEFT JOIN account_personal ape
        ...
        public static function getRecordByFirstName($first_name){
            $result = mysql::select('account_employment aem
                                     LEFT JOIN account_personal ape
                                     ON ape.account_id = aem.account_id
                                     LEFT JOIN master_account_type mat
                                     ON aem.account_type_id = mat.id
        ...
        public static function getRecordByDesignationId($account_designation_id){
            $result = mysql::select('account_employment aem USE INDEX(account_designation_id)
                                     LEFT JOIN account_personal ape
                                     ON ape.account_id = aem.account_id
                                     LEFT JOIN master_account_type mat
                                     ON aem.account_type_id = mat.id
        ...
        public static function getRecordByDepartmentId($account_department_id){
            $result = mysql::select('account_employment aem USE INDEX(account_department_id)
                                     LEFT JOIN account_personal ape
                                     ON ape.account_id = aem.account_id
                                     LEFT JOIN master_account_type mat
                                     ON aem.account_type_id = mat.id
        ...
        public static function getByReportTo($account_id){
            $result = mysql::select('account_employment aem USE INDEX(report_to)
                                     LEFT JOIN account_personal ape
                                     ON ape.account_id = aem.account_id
                                     LEFT JOIN master_account_type mat
                                     ON aem.account_type_id = mat.id
        ...
        public static function getPersonalByAccountId($account_id){
            $result = mysql::select('account_personal USE INDEX(account_id)
                                    ',
                                    '*, 
        ...
        public static function getAccountBlacklist(){
            ...
            $result = mysql::select("account_blacklist abl",
                                    'abl.*,
        ...
        public static function getAccountPromotionByAccountId($account_id){
            ...
            $result = mysql::select('account_promotion apr USE INDEX(account_id)
                                     LEFT JOIN account_personal ape
        ...
        public static function getAccountPromotionById($id){
            $result = mysql::select('account_promotion apr
                                LEFT JOIN account_personal ape
                                ON ape.account_id = apr.account_id
                                LEFT JOIN master_account_department mad
                                ON apr.account_department_id = mad.id 
        ...
        public static function getEmploymentByAccountIdAndRoleId($account_id, $role_id, $status_id='1'){
            $result = mysql::select('account_employment aem
                                    ...
                                    ', 
                                    "aem.account_id = '{$account_id}' AND FIND_IN_SET ('{$role_id}', REPLACE(aem.account_role_id, '-', ',')) AND aem.account_status_id = '{$status_id}'"); //account_status_id = 1 : ACTIVE
            return $result;
        }
